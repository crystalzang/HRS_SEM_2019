...
h16_R_all_adl<-h16_R_all_id %>%
  filter(#ADL
    ...
    mutate(Depression_depressed2=if_else(Depression_depressed==5, 0, 1),
           ...
           Depression=Depression_depressed2+Depression_efforts2+Depression_sleep2+Depression_loneliness2+Depression_sad2+Depression_unmotivated2-Depression_happy2-Depression_enjoy2)
