...
#transformation
```{r}
log_S_CESD = log10(dyad_female_helper$S_CESD)
ggplot(data=dyad_female_helper,aes(x=log_S_CESD))+geom_histogram()
log_S_CESD = log10(dyad_female_helper$S_CESD)
ggplot(data=dyad_female_helper,aes(x=log_S_CESD))+geom_histogram()
```
...
```{r}
ggplot(data=dyad_female_helper,aes(x=expenditure))+geom_histogram()
