...
write.csv(dyad_helper_f_join2, file="dyad_helper_f.csv", row.names = F)
```
...
write.csv(dyad_helper_m_join2, file="dyad_helper_m.csv", row.names = F)
...
write.csv(dyad_all, file="dyad_all.csv", row.names = F)
