...
both_helper <-left_join(respondent_helper,spouse_helper, by = c("spouse_id" = "RAHHIDPN"))%>%
...
write.csv(dyad_type1_both_helper, file="dyad_type1_both_helper.csv", row.names = F)
