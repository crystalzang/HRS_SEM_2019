...
```{r}
model_f <- '
            S_CESD ~ S_ADL +  R_ADL + hhour.z + exp.z + S_self_health + R_self_health + S_income_i.z + R_income_i.z + R_hostital_stay.z
            R_CESD ~ R_ADL + S_ADL + hhour.z + exp.z + S_self_health + R_self_health + S_income_i.z + R_income_i.z + R_hostital_stay.z
            hhour.z~ R_ADL + S_ADL
            exp.z ~ R_ADL + S_ADL 
...
#smaller model
model_f <- '
            S_CESD ~ S_ADL  + exp.z + R_income_i.z
            R_CESD ~ R_ADL+ S_self_health + R_self_health + S_income_i.z
            hhour.z~ R_ADL
            exp.z ~  S_ADL 
            S_self_health ~ S_ADL 
            R_self_health ~ R_ADL 
